...
\input{color-science/electromagnetic-spectrum.tex}

\input{color-science/human-visual-system.tex}

\input{color-science/basic-colorimetry.tex}

\input{color-science/advanced-colorimetry.tex}

\input{color-science/representing-color.tex}

\input{color-science/color-imaging-systems.tex}
