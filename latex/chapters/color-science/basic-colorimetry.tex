...
% These reasons lead the CIE to transform the Wright & Guild 1931 2? RGB CMFs into a new set of functions based on new primary stimuli X, Y, Z: The CIE 1931 2? Standard Observer XYZ? color matching functions. When conceiving the linear transformation that converts Wright & Guild 1931 2? RGB? CMFs into the CIE 1931 2? Standard Observer XYZ CMFs, the CIE ensured that the Y? function was equal to the CIE 1924 Photopic Standard Observer luminous efficiency function V(?) and that all the functions were positive.
