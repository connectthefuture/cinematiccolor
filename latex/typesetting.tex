...
\ifdefined\HCode
    \HCode{
        <div class="border d-block my-3 p-3">
            <div id="complex-jeri-embedding" class="jeri-container"></div>
        </div>
        <script type="text/javascript">
            ...
            Jeri.renderViewer(document.getElementById('complex-jeri-embedding'), data);
        </script>
    }
\fi
\end{lstlisting}
